...
max_overflow=10 - the number of connections to allow in connection pool “overflow”,
...
pool_size=5 - the number of connections to keep open inside the connection pool.
    ...
    Current set to 10 (double the default to give us more space as we grow)
...
pool_recycle=-1 - this setting causes the pool to recycle connections after the given number
    ...
    Currently set to 28800 (8 hours) to match MySQL behavior.
"""
